        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                ...
                if isRecent {
                    ...
                    Button(action: {
                        HapticManager.instance.impact(style: .rigid)
                        viewModel.addToMyWorkouts(workoutName: workout.WorkoutName, exersiseModules: workout.exercises)
                        ...
                        Image(systemName: "plus")
                            ...
                            .frame(width: 50)
                            .bold()
                            .frame(width: getScreenBounds().width * 0.03, height: getScreenBounds().height * 0.03)
                            .padding(.trailing,5)
                    }
                    ...
                    .alert(isPresented: $showingDeleteAlert) {
                        Alert(title: Text("Delete My Workouts"),
                    ...
                    HStack(spacing: 3) {
                        let currentWorkout = ScheduleWorkout(id: 69, name: workout.WorkoutName, exercises: workout.exercises, time: workout.competionDate, HasBeenDone: false)
                        HStack{
                        ...
                        .background(.red.opacity(0.0001))
                            ...
                            .background(
                                NavigationLink(destination: createWorkout(homePageVeiwModel: viewModel, workoutLogViewModel: viewModel.newViewModel, isNavigationBarHidden: $isNavigationBarHidden, currentWorkout: currentWorkout, editingMyWorkouts: workout.id), isActive: $isLinkActive) {
                                    EmptyView()
                                }
                            )
                            .onTapGesture {
                    ...
                    }.frame(width: getScreenBounds().width * 0.09)
                        .padding(.trailing, 5)
